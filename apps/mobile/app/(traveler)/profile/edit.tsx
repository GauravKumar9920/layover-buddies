...
export default function TravelerProfileEditScreen() {
  ...
  usePreventRemove(dirty && !saving, ({ data }) => {
    Alert.alert(
      ...
      "Your unsaved traveler profile changes will be lost.",
      [
  ...
  return (
    ...
    >
      <Header
        ...
        showBack
        backFallback="/(traveler)/(tabs)/profile"
      />
      <ScrollView
            ...
            <>
              ...
              <View style={{ flexDirection: "row", gap: 12 }}>
                ...
                <Input
                  ...
                  onChangeText={(value) => {
                    setDirty(true);
                    setFlightOut(value.toUpperCase());
                  }}
                  placeholder="AI191"
                  autoCapitalize="characters"
                  maxLength={20}
              ...
              {TRAVEL_PACE_OPTIONS.map((option) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setDirty(true);
                      setTravelPace(selected ? null : option.key);
                    }}
                    activeOpacity={0.82}
