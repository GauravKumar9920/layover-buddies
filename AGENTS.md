...
The April-era task list (smoke test, booking UI, seed data, constants) is **done** — history lives in git. The live roadmap is in **`docs/project/NEXT_TASKS.md`**. Headline items as of 2026-09-08:
